...
DEF("record", HAS_ARG, QEMU_OPTION_record,
	"-record <log_file_name>  record VM execution, only support uniprocessor, ee100pro, and DMA IDE\n", QEMU_ARCH_I386)
STEXI
@item -record @var{filename}
@findex -record
Start record VM execution
ETEXI


DEF("replay", HAS_ARG, QEMU_OPTION_replay,
	"-replay <log_file_name> replay VM execution \n", QEMU_ARCH_I386)
STEXI
@item -replay @var{filename}
@findex -replay
Replay VM execution
ETEXI
